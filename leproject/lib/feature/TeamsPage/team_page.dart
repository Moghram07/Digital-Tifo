...
class TeamsPages extends StatefulWidget {
  ...
  const TeamsPages({super.key, required this.email});
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          color: Colors.white,
          child: WebViewPage(
            url: "https://www.spl.com.sa/en/table?compSeason=858",
          ),
        ),
      ),
    );
...
//         child: WebViewPage(url: "https://www.spl.com.sa/en/table?compSeason=858")),
//     );
//   }
